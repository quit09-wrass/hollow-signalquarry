...
const sdk = new CoinbaseWalletSDK({
  appName: "Hollow Signalquarry (Built for Base)",
...
function mount() {
  ...
  root.style.maxWidth = "1140px";
  root.style.margin = "24px auto";
  root.style.fontFamily = "ui-sans-serif, system-ui";

  const h1 = document.createElement("h1");
  h1.textContent = "Hollow Signalquarry";

  const blurb = document.createElement("div");
  blurb.textContent =
    "Built for Base: connect a wallet, confirm chainId, and read balances/blocks/tokens with explorer references.";
